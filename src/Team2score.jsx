...
//   // }, [])
//   // console.log("scores:", showScores);
//   console.log("disScore:", displayScores);
//   if (displayScores !== undefined) {
//     const battingData = Object.values(displayScores.batTeamDetails.batsmenData)
//     const bowlingData = Object.values(displayScores.bowlTeamDetails.bowlersData)
//     return (
...
//                         <td className='text-[10px]'>{batsmen.outDesc}</td>
//                       </div>
//                       <td className='text-[13px] p-2'>{batsmen.runs}</td>
//                       <td className='text-[13px] p-2'>{batsmen.balls}</td>
//                       <td className='text-[13px] p-2'>{batsmen.fours}</td>
//                       <td className='text-[13px] p-2'>{batsmen.sixes}</td>
//                       <td className='text-[13px] p-2'>{batsmen.strikeRate}</td>
//                     </tr>
//                   </>
//                 )
//               })
...
//                       <td className='text-[13px] p-2'>{bowler.overs}</td>
//                       <td className='text-[13px] p-2'>{bowler.runs}</td>
//                       <td className='text-[13px] p-2'>{bowler.wickets}</td>
//                       <td className='text-[13px] p-2'>{bowler.economy}</td>
//                       <td className='text-[13px] p-2'>{bowler.wides}</td>
//                       <td className='text-[13px] p-2'>{bowler.no_balls}</td>
//                     </tr>
//                   </>
//                 )
//               })
...
//   else {
//     return (
//       <div className='ml-[42.5%] font-medium text-sm lg:text-[20px] mt-5'>
//         Innings is not started yet
//       </div>
//     )
//   }
// }
