...
//                     if (innerMatches.seriesAdWrapper) {
//                       return (
//                         innerMatches.seriesAdWrapper.matches.map((matchList) => {
//                           if (matchList.matchInfo.matchFormat === "TEST") {
//                             if (matchList.matchScore) {
//                               if (matchList.matchScore.team2Score.inngs2) {
//                                 return (
//                                   <>
//                                     <div className='w-[95%] bg-gray-200 m-auto px-3 py-3 text-base flex flex-col my-3 rounded-sm gap-y-[1px]'>
...
//                                 )
//                               }
//                               else if (matchList.matchScore.team1Score.inngs2) {
//                                 return (
//                                   <>
//                                     <div className='w-[95%] bg-gray-200 m-auto px-3 py-3 text-base flex flex-col my-3 rounded-sm gap-y-[1px]'>
//                                       <span className='text-gray-800 font-medium text-[13px]'>{matchList.matchInfo.seriesName.substring(0, 39) + "..."}</span>
...
//                                 )
//                               }
//                               else if (matchList.matchScore.team2Score.inngs1) {
//                                 return (
//                                   <>
//                                     <div className='w-[95%] bg-gray-200 m-auto px-3 py-3 text-base flex flex-col my-3 rounded-sm gap-y-[1px]'>
//                                       <span className='text-gray-800 font-medium text-[13px]'>{matchList.matchInfo.seriesName.substring(0, 39) + "..."}</span>
...
//                                 )
//                               }
//                               else if (matchList.matchScore.team1Score) {
//                                 return (
//                                   <>
//                                     <div className='w-[95%] bg-gray-200 m-auto px-3 py-3 text-base flex flex-col my-3 rounded-sm gap-y-[1px]'>
//                                       <span className='text-gray-800 font-medium text-[13px]'>{matchList.matchInfo.seriesName.substring(0, 39) + "..."}</span>
...
//                             if (matchList.matchScore) {
//                               if (matchList.matchScore.team2Score) {
//                                 return (
//                                   <>
//                                     <div className='w-[95%] bg-gray-200 m-auto px-3 py-3 text-base flex flex-col my-3 rounded-sm gap-y-[1px]'>
//                                       <span className='text-gray-800 font-medium text-[13px]'>{matchList.matchInfo.seriesName.substring(0, 39) + "..."}</span>
