          ...
          <>
            <div className='m-2 flex flex-col items-center gap-y-2'>
              ...
              <div className='flex flex-wrap lg:gap-x-3 mt-4'>
                ...
                <button className={`h-9 w-24 border rounded-md lg:w-[305px] ${link == "third" ? "bg-sky-500 text-white" : "bg-white"}`} onClick={() => { dispatch(matchScores(scoreRes.data.scoreCard)) }}><Link to="/scorecard/team1sec" onClick={() => { activeLink('third') }}>{scoreRes.data.matchHeader.team1.shortName} 2nd Inn</Link></button>
                <button className={`h-9 w-24 border rounded-md lg:w-[305px] ${link == "fourth" ? "bg-sky-500 text-white" : "bg-white"}`} onClick={() => { dispatch(matchScores(scoreRes.data.scoreCard)) }}><Link to="/scorecard/team2sec" onClick={() => { activeLink('fourth') }}>{scoreRes.data.matchHeader.team2.shortName} 2nd Inn</Link></button>
              </div>
            </div>
            <Outlet />
          </>
